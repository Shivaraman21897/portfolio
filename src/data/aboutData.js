export const aboutData = {
    title: "Who I am",
    description1: "Hi, I'm Sivaraman, a web designer and developer based in Chennai, Tamil Nadu. I am a professional and passionate programmer with a strong focus on web development.",
    description2: "In my daily life, I embrace the role of a quick learner with a self-learning attitude. I am constantly motivated to learn and explore new technologies, keeping up with the ever-evolving landscape of software engineering. I find great joy in diving deep into different stacks and frameworks to expand my skill set and stay ahead of the curve ",
    description3:"Currently, my stack revolves around Node.js, React, Redux, Jest, Bootstrap, Material UI, MongoDB, MySQL, and more. These technologies empower me to build robust and scalable web applications. I am proficient in utilizing Node.js for server-side development, while React and Redux allow me to create dynamic and interactive user interfaces",
